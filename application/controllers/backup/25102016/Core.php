...
class Core extends MY_Controller {
	...
	public function initTransactionTest2($patPass = NULL) {
		...
		if($post["PaymentType"] == 1) { // PatPass
			...
			$post["UserRut"] = "15.608.145-0";
			$post["UserName"] = "prueba";
			$post["UserLastName1"] = "pruebaA";
			$post["UserLastName2"] = "pruebaB";
			$post["UserMail"] = "test1@test1.com";
			$post["UserCellPhoneNumber"] = "12345678";
	...
	public function initTransaction2() {
		...
		try {
			...
			switch($oTrx->idPaymentType) {
				...
				case 5:
					//$this->_postToken("123", "http://www.google.cl");
					break;
			}
