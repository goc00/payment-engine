<?php class Payment_type_model extends CI_Model 
{
    ...
    {
		$res = $this->db->get_where($this->tableName, array("prefix" => $prefix));
    ...
    {	
		$res = $this->db->get_where($this->tableName, array("idPaymentType" => $idPaymentType));
    ...
    function findByCommerceAndCountry($commerceCode, $countryAlpha2)
    {
        $query = $this->db
            ...
            ->join("$this->tableName as pt", 'pt.idPaymentType = commercept.idPaymentType')
